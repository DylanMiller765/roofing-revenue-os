...
const campaignInputs: CampaignRow[] = [
	{
		...
		intent: "High-intent replacement",
		dailyBudget: 85,
		spend: 1842,
		clicks: 91,
		leads: 14,
	...
	},
	{
		id: "storm",
		name: "Storm damage",
		intent: "Hail and damage inspection",
		dailyBudget: 60,
		spend: 1106,
		clicks: 68,
		leads: 8,
...
export const searchTerms = [
	...
	{
		term: "hail damage roof inspection",
		campaignId: "storm",
	...
	{
		term: "emergency roof leak repair",
		campaignId: "repair",
	...
	{
		term: "roofing jobs near me",
		campaignId: "research",
		campaign: "Broad research",
		spend: 126,
		clicks: 21,
		leads: 2,
		qualified: 0,
		booked: 0,
		disposition: "Negative review",
	},
	{
		term: "diy roof cost calculator",
		campaignId: "research",
		campaign: "Broad research",
		spend: 94,
		clicks: 14,
...
export const auditTrail: ChangeAuditEntry[] = [
	{
		...
		reason:
			"Meaningful search-term spend produced no qualified homeowner outcome.",
		supportingMetrics: {
			spend: 126,
			clicks: 21,
			qualifiedLeads: 0,
		...
		status: "blocked",
		policyReasons: [
			"Mock environment has no live provider adapter or credentials.",
		],
	},
];
